...
FEATURE(ColorMult, "Multiply")
	SCENARIO("Multiply two colors")
		...
		THEN(
				"the result should be a multiply blend of the two color's components");
...
FEATURE(ColorAlphaBlend, "Alpha blend")
	SCENARIO("Alpha blend two colors")
		...
		THEN(
				"the result should be an alpha blend of the two color's components")
		SHOULD_INT_EQUAL(result.r,
				((int )c1.r * (255 - c2.a) + (int )c2.r * c2.a) / 255);
		SHOULD_INT_EQUAL(result.g,
				((int )c1.g * (255 - c2.a) + (int )c2.g * c2.a) / 255);
		SHOULD_INT_EQUAL(result.b,
				((int )c1.r * (255 - c2.a) + (int )c2.b * c2.a) / 255);
