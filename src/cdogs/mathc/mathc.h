...
mfloat_t* vec2_clamp(mfloat_t *result, mfloat_t *a, mfloat_t *lower,
		mfloat_t *higher);
...
mfloat_t* vec2_bezier3(mfloat_t *result, mfloat_t *a, mfloat_t *b, mfloat_t *c,
		mfloat_t p);
mfloat_t* vec2_bezier4(mfloat_t *result, mfloat_t *a, mfloat_t *b, mfloat_t *c,
		mfloat_t *d, mfloat_t p);
...
mint_t* vec2i_bezier3(mint_t *result, mint_t *a, mint_t *b, mint_t *c,
		mfloat_t p);
mint_t* vec2i_bezier4(mint_t *result, mint_t *a, mint_t *b, mint_t *c,
		mint_t *d, mfloat_t p);
...
mfloat_t* vec3_clamp(mfloat_t *result, mfloat_t *a, mfloat_t *lower,
		mfloat_t *higher);
...
mfloat_t* vec3_bezier3(mfloat_t *result, mfloat_t *a, mfloat_t *b, mfloat_t *c,
		mfloat_t p);
mfloat_t* vec3_bezier4(mfloat_t *result, mfloat_t *a, mfloat_t *b, mfloat_t *c,
		mfloat_t *d, mfloat_t p);
...
mint_t* vec3i_bezier3(mint_t *result, mint_t *a, mint_t *b, mint_t *c,
		mfloat_t p);
mint_t* vec3i_bezier4(mint_t *result, mint_t *a, mint_t *b, mint_t *c,
		mint_t *d, mfloat_t p);
...
mfloat_t* vec4_clamp(mfloat_t *result, mfloat_t *a, mfloat_t *lower,
		mfloat_t *higher);
...
mfloat_t* quat_from_yaw_pitch_roll(mfloat_t *result, mfloat_t yaw,
		mfloat_t pitch, mfloat_t roll);
...
MATHC_INLINE bool psvec2_is_nearly_equal(struct vec2 *a, struct vec2 *b,
		mfloat_t epsilon) {
...
MATHC_INLINE struct vec2* psvec2_assign_vec2i(struct vec2 *result,
		struct vec2i *a) {
...
MATHC_INLINE struct vec2* psvec2_add(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_add((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_subtract(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_subtract((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_scale(struct vec2 *result, struct vec2 *a,
		mfloat_t scalar) {
	vec2_scale((mfloat_t*) result, (mfloat_t*) a, scalar);
	return result;
}

MATHC_INLINE struct vec2* psvec2_multiply(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_multiply_mat2(struct vec2 *result,
		struct vec2 *a, struct mat2 *m) {
	vec2_multiply_mat2((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct vec2* psvec2_divide(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_divide((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_snap(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
...
MATHC_INLINE struct vec2* psvec2_max(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_max((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_min(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_min((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_clamp(struct vec2 *result, struct vec2 *a,
		struct vec2 *lower, struct vec2 *higher) {
	vec2_clamp((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) lower,
			(mfloat_t*) higher);
	return result;
}

MATHC_INLINE struct vec2* psvec2_normalize(struct vec2 *result,
		struct vec2 *a) {
	vec2_normalize((mfloat_t*) result, (mfloat_t*) a);
	return result;
}

MATHC_INLINE struct vec2* psvec2_project(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_project((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_slide(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
	vec2_slide((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec2* psvec2_reflect(struct vec2 *result, struct vec2 *a,
		struct vec2 *b) {
...
MATHC_INLINE struct vec2* psvec2_rotate(struct vec2 *result, struct vec2 *a,
		mfloat_t angle) {
	vec2_rotate((mfloat_t*) result, (mfloat_t*) a, angle);
	return result;
}

MATHC_INLINE struct vec2* psvec2_lerp(struct vec2 *result, struct vec2 *a,
		struct vec2 *b, mfloat_t p) {
	vec2_lerp((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b, p);
	return result;
}

MATHC_INLINE struct vec2* psvec2_bezier3(struct vec2 *result, struct vec2 *a,
		struct vec2 *b, struct vec2 *c, mfloat_t p) {
	vec2_bezier3((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b,
			(mfloat_t*) c, p);
	return result;
}

MATHC_INLINE struct vec2* psvec2_bezier4(struct vec2 *result, struct vec2 *a,
		struct vec2 *b, struct vec2 *c, struct vec2 *d, mfloat_t p) {
	vec2_bezier4((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b,
			(mfloat_t*) c, (mfloat_t*) d, p);
	return result;
}
...
MATHC_INLINE struct vec2i* psvec2i_assign(struct vec2i *result,
		struct vec2i *a) {
	vec2i_assign((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_assign_vec2(struct vec2i *result,
		struct vec2 *a) {
...
MATHC_INLINE struct vec2i* psvec2i_add(struct vec2i *result, struct vec2i *a,
		struct vec2i *b) {
	vec2i_add((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_subtract(struct vec2i *result,
		struct vec2i *a, struct vec2i *b) {
	vec2i_subtract((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_scale(struct vec2i *result, struct vec2i *a,
		mfloat_t scalar) {
	vec2i_scale((mint_t*) result, (mint_t*) a, scalar);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_multiply(struct vec2i *result,
		struct vec2i *a, struct vec2i *b) {
	vec2i_multiply((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_multiply_mat2(struct vec2i *result,
		struct vec2i *a, struct mat2 *m) {
	vec2i_multiply_mat2((mint_t*) result, (mint_t*) a, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_divide(struct vec2i *result, struct vec2i *a,
		struct vec2i *b) {
	vec2i_divide((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_snap(struct vec2i *result, struct vec2i *a,
		struct vec2i *b) {
	vec2i_snap((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_negative(struct vec2i *result,
		struct vec2i *a) {
	vec2i_negative((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_inverse(struct vec2i *result,
		struct vec2i *a) {
...
MATHC_INLINE struct vec2i* psvec2i_max(struct vec2i *result, struct vec2i *a,
		struct vec2i *b) {
	vec2i_max((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_min(struct vec2i *result, struct vec2i *a,
		struct vec2i *b) {
	vec2i_min((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_clamp(struct vec2i *result, struct vec2i *a,
		struct vec2i *lower, struct vec2i *higher) {
	vec2i_clamp((mint_t*) result, (mint_t*) a, (mint_t*) lower,
			(mint_t*) higher);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_normalize(struct vec2i *result,
		struct vec2i *a) {
	vec2i_normalize((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_project(struct vec2i *result,
		struct vec2i *a, struct vec2i *b) {
	vec2i_project((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_slide(struct vec2i *result, struct vec2i *a,
		struct vec2i *b) {
	vec2i_slide((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_reflect(struct vec2i *result,
		struct vec2i *a, struct vec2i *b) {
	vec2i_reflect((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_tangent(struct vec2i *result,
		struct vec2i *a) {
	vec2i_tangent((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_rotate(struct vec2i *result, struct vec2i *a,
		mfloat_t angle) {
	vec2i_rotate((mint_t*) result, (mint_t*) a, angle);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_lerp(struct vec2i *result, struct vec2i *a,
		struct vec2i *b, mfloat_t p) {
	vec2i_lerp((mint_t*) result, (mint_t*) a, (mint_t*) b, p);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_bezier3(struct vec2i *result,
		struct vec2i *a, struct vec2i *b, struct vec2i *c, mfloat_t p) {
	vec2i_bezier3((mint_t*) result, (mint_t*) a, (mint_t*) b, (mint_t*) c, p);
	return result;
}

MATHC_INLINE struct vec2i* psvec2i_bezier4(struct vec2i *result,
		struct vec2i *a, struct vec2i *b, struct vec2i *c, struct vec2i *d,
		mfloat_t p) {
	vec2i_bezier4((mint_t*) result, (mint_t*) a, (mint_t*) b, (mint_t*) c,
			(mint_t*) d, p);
	return result;
}
...
MATHC_INLINE bool psvec3_is_nearly_equal(struct vec3 *a, struct vec3 *b,
		mfloat_t epsilon) {
	return vec3_is_nearly_equal((mfloat_t*) a, (mfloat_t*) b, epsilon);
}

MATHC_INLINE struct vec3* psvec3(struct vec3 *result, mfloat_t x, mfloat_t y,
		mfloat_t z) {
...
MATHC_INLINE struct vec3* psvec3_assign_vec3i(struct vec3 *result,
		struct vec3i *a) {
...
MATHC_INLINE struct vec3* psvec3_add(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_add((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_subtract(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_subtract((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_scale(struct vec3 *result, struct vec3 *a,
		mfloat_t scalar) {
	vec3_scale((mfloat_t*) result, (mfloat_t*) a, scalar);
	return result;
}

MATHC_INLINE struct vec3* psvec3_multiply(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_multiply_mat3(struct vec3 *result,
		struct vec3 *a, struct mat3 *m) {
	vec3_multiply_mat3((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct vec3* psvec3_divide(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_divide((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_snap(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
...
MATHC_INLINE struct vec3* psvec3_max(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_max((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_min(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_min((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_clamp(struct vec3 *result, struct vec3 *a,
		struct vec3 *lower, struct vec3 *higher) {
	vec3_clamp((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) lower,
			(mfloat_t*) higher);
	return result;
}

MATHC_INLINE struct vec3* psvec3_cross(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_cross((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_normalize(struct vec3 *result,
		struct vec3 *a) {
	vec3_normalize((mfloat_t*) result, (mfloat_t*) a);
	return result;
}

MATHC_INLINE struct vec3* psvec3_project(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_project((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_slide(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_slide((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_reflect(struct vec3 *result, struct vec3 *a,
		struct vec3 *b) {
	vec3_reflect((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec3* psvec3_lerp(struct vec3 *result, struct vec3 *a,
		struct vec3 *b, mfloat_t p) {
	vec3_lerp((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b, p);
	return result;
}

MATHC_INLINE struct vec3* psvec3_bezier3(struct vec3 *result, struct vec3 *a,
		struct vec3 *b, struct vec3 *c, mfloat_t p) {
	vec3_bezier3((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b,
			(mfloat_t*) c, p);
	return result;
}

MATHC_INLINE struct vec3* psvec3_bezier4(struct vec3 *result, struct vec3 *a,
		struct vec3 *b, struct vec3 *c, struct vec3 *d, mfloat_t p) {
	vec3_bezier4((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b,
			(mfloat_t*) c, (mfloat_t*) d, p);
	return result;
}
...
MATHC_INLINE struct vec3i* psvec3i(struct vec3i *result, mint_t x, mint_t y,
		mint_t z) {
	vec3i((mint_t*) result, x, y, z);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_assign(struct vec3i *result,
		struct vec3i *a) {
	vec3i_assign((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_assign_vec3(struct vec3i *result,
		struct vec3 *a) {
...
MATHC_INLINE struct vec3i* psvec3i_add(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_add((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_subtract(struct vec3i *result,
		struct vec3i *a, struct vec3i *b) {
	vec3i_subtract((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_scale(struct vec3i *result, struct vec3i *a,
		mfloat_t scalar) {
	vec3i_scale((mint_t*) result, (mint_t*) a, scalar);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_multiply(struct vec3i *result,
		struct vec3i *a, struct vec3i *b) {
	vec3i_multiply((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_multiply_mat3(struct vec3i *result,
		struct vec3i *a, struct mat3 *m) {
	vec3i_multiply_mat3((mint_t*) result, (mint_t*) a, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_divide(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_divide((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_snap(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_snap((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_negative(struct vec3i *result,
		struct vec3i *a) {
	vec3i_negative((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_inverse(struct vec3i *result,
		struct vec3i *a) {
...
MATHC_INLINE struct vec3i* psvec3i_max(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_max((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_min(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_min((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_clamp(struct vec3i *result, struct vec3i *a,
		struct vec3i *lower, struct vec3i *higher) {
	vec3i_clamp((mint_t*) result, (mint_t*) a, (mint_t*) lower,
			(mint_t*) higher);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_cross(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_cross((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_normalize(struct vec3i *result,
		struct vec3i *a) {
	vec3i_normalize((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_project(struct vec3i *result,
		struct vec3i *a, struct vec3i *b) {
	vec3i_project((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_slide(struct vec3i *result, struct vec3i *a,
		struct vec3i *b) {
	vec3i_slide((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_reflect(struct vec3i *result,
		struct vec3i *a, struct vec3i *b) {
	vec3i_reflect((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_lerp(struct vec3i *result, struct vec3i *a,
		struct vec3i *b, mfloat_t p) {
	vec3i_lerp((mint_t*) result, (mint_t*) a, (mint_t*) b, p);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_bezier3(struct vec3i *result,
		struct vec3i *a, struct vec3i *b, struct vec3i *c, mfloat_t p) {
	vec3i_bezier3((mint_t*) result, (mint_t*) a, (mint_t*) b, (mint_t*) c, p);
	return result;
}

MATHC_INLINE struct vec3i* psvec3i_bezier4(struct vec3i *result,
		struct vec3i *a, struct vec3i *b, struct vec3i *c, struct vec3i *d,
		mfloat_t p) {
	vec3i_bezier4((mint_t*) result, (mint_t*) a, (mint_t*) b, (mint_t*) c,
			(mint_t*) d, p);
	return result;
}
...
MATHC_INLINE bool psvec4_is_nearly_equal(struct vec4 *a, struct vec4 *b,
		mfloat_t epsilon) {
	return vec4_is_nearly_equal((mfloat_t*) a, (mfloat_t*) b, epsilon);
}

MATHC_INLINE struct vec4* psvec4(struct vec4 *result, mfloat_t x, mfloat_t y,
...
MATHC_INLINE struct vec4* psvec4_assign_vec4i(struct vec4 *result,
		struct vec4i *a) {
...
MATHC_INLINE struct vec4* psvec4_add(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
	vec4_add((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec4* psvec4_subtract(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
	vec4_subtract((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec4* psvec4_scale(struct vec4 *result, struct vec4 *a,
		mfloat_t scalar) {
	vec4_scale((mfloat_t*) result, (mfloat_t*) a, scalar);
	return result;
}

MATHC_INLINE struct vec4* psvec4_multiply(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
	vec4_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec4* psvec4_multiply_mat4(struct vec4 *result,
		struct vec4 *a, struct mat4 *m) {
	vec4_multiply_mat4((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct vec4* psvec4_divide(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
	vec4_divide((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec4* psvec4_snap(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
...
MATHC_INLINE struct vec4* psvec4_max(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
	vec4_max((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec4* psvec4_min(struct vec4 *result, struct vec4 *a,
		struct vec4 *b) {
	vec4_min((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct vec4* psvec4_clamp(struct vec4 *result, struct vec4 *a,
		struct vec4 *lower, struct vec4 *higher) {
	vec4_clamp((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) lower,
			(mfloat_t*) higher);
	return result;
}

MATHC_INLINE struct vec4* psvec4_normalize(struct vec4 *result,
		struct vec4 *a) {
	vec4_normalize((mfloat_t*) result, (mfloat_t*) a);
	return result;
}

MATHC_INLINE struct vec4* psvec4_lerp(struct vec4 *result, struct vec4 *a,
		struct vec4 *b, mfloat_t p) {
...
MATHC_INLINE struct vec4i* psvec4i(struct vec4i *result, mint_t x, mint_t y,
		mint_t z, mint_t w) {
	vec4i((mint_t*) result, x, y, z, w);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_assign(struct vec4i *result,
		struct vec4i *a) {
	vec4i_assign((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_assign_vec4(struct vec4i *result,
		struct vec4 *a) {
...
MATHC_INLINE struct vec4i* psvec4i_add(struct vec4i *result, struct vec4i *a,
		struct vec4i *b) {
	vec4i_add((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_subtract(struct vec4i *result,
		struct vec4i *a, struct vec4i *b) {
	vec4i_subtract((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_scale(struct vec4i *result, struct vec4i *a,
		mfloat_t scalar) {
	vec4i_scale((mint_t*) result, (mint_t*) a, scalar);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_multiply(struct vec4i *result,
		struct vec4i *a, struct vec4i *b) {
	vec4i_multiply((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_multiply_mat4(struct vec4i *result,
		struct vec4i *a, struct mat4 *m) {
	vec4i_multiply_mat4((mint_t*) result, (mint_t*) a, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_divide(struct vec4i *result, struct vec4i *a,
		struct vec4i *b) {
	vec4i_divide((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_snap(struct vec4i *result, struct vec4i *a,
		struct vec4i *b) {
	vec4i_snap((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_negative(struct vec4i *result,
		struct vec4i *a) {
	vec4i_negative((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_inverse(struct vec4i *result,
		struct vec4i *a) {
...
MATHC_INLINE struct vec4i* psvec4i_max(struct vec4i *result, struct vec4i *a,
		struct vec4i *b) {
	vec4i_max((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_min(struct vec4i *result, struct vec4i *a,
		struct vec4i *b) {
	vec4i_min((mint_t*) result, (mint_t*) a, (mint_t*) b);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_clamp(struct vec4i *result, struct vec4i *a,
		struct vec4i *lower, struct vec4i *higher) {
	vec4i_clamp((mint_t*) result, (mint_t*) a, (mint_t*) lower,
			(mint_t*) higher);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_normalize(struct vec4i *result,
		struct vec4i *a) {
	vec4i_normalize((mint_t*) result, (mint_t*) a);
	return result;
}

MATHC_INLINE struct vec4i* psvec4i_lerp(struct vec4i *result, struct vec4i *a,
		struct vec4i *b, mfloat_t p) {
...
MATHC_INLINE bool psquat_is_nearly_equal(struct quat *a, struct quat *b,
		mfloat_t epsilon) {
	return quat_is_nearly_equal((mfloat_t*) a, (mfloat_t*) b, epsilon);
}

MATHC_INLINE struct quat* psquat(struct quat *result, mfloat_t x, mfloat_t y,
		mfloat_t z, mfloat_t w) {
...
MATHC_INLINE struct quat* psquat_scale(struct quat *result, struct quat *a,
		mfloat_t scalar) {
	quat_scale((mfloat_t*) result, (mfloat_t*) a, scalar);
	return result;
}

MATHC_INLINE struct quat* psquat_multiply(struct quat *result, struct quat *a,
		struct quat *b) {
	quat_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct quat* psquat_divide(struct quat *result, struct quat *a,
		struct quat *b) {
...
MATHC_INLINE struct quat* psquat_conjugate(struct quat *result,
		struct quat *a) {
...
MATHC_INLINE struct quat* psquat_normalize(struct quat *result,
		struct quat *a) {
	quat_normalize((mfloat_t*) result, (mfloat_t*) a);
	return result;
}

MATHC_INLINE struct quat* psquat_power(struct quat *result, struct quat *a,
		mfloat_t exponent) {
	quat_power((mfloat_t*) result, (mfloat_t*) a, exponent);
	return result;
}

MATHC_INLINE struct quat* psquat_from_axis_angle(struct quat *result,
		struct vec3 *a, mfloat_t angle) {
	quat_from_axis_angle((mfloat_t*) result, (mfloat_t*) a, angle);
	return result;
}

MATHC_INLINE struct quat* psquat_from_vec3(struct quat *result, struct vec3 *a,
		struct vec3 *b) {
	quat_from_vec3((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct quat* psquat_from_mat4(struct quat *result,
		struct mat4 *a) {
	quat_from_mat4((mfloat_t*) result, (mfloat_t*) a);
	return result;
}

MATHC_INLINE struct quat* psquat_from_yaw_pitch_roll(struct quat *result,
		mfloat_t yaw, mfloat_t pitch, mfloat_t roll) {
	quat_from_yaw_pitch_roll((mfloat_t*) result, yaw, pitch, roll);
	return result;
}

MATHC_INLINE struct quat* psquat_lerp(struct quat *result, struct quat *a,
		struct quat *b, mfloat_t p) {
	quat_lerp((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b, p);
	return result;
}

MATHC_INLINE struct quat* psquat_slerp(struct quat *result, struct quat *a,
		struct quat *b, mfloat_t p) {
...
MATHC_INLINE struct mat2* psmat2_assign_mat3(struct mat2 *result,
		struct mat3 *m) {
	mat2_assign_mat3((mfloat_t*) result, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct mat2* psmat2_assign_mat4(struct mat2 *result,
		struct mat4 *m) {
	mat2_assign_mat4((mfloat_t*) result, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct mat2* psmat2_transpose(struct mat2 *result,
		struct mat2 *m) {
...
MATHC_INLINE struct mat2* psmat2_scale(struct mat2 *result, struct mat2 *m,
		mfloat_t s) {
	mat2_scale((mfloat_t*) result, (mfloat_t*) m, s);
	return result;
}

MATHC_INLINE struct mat2* psmat2_multiply(struct mat2 *result, struct mat2 *a,
		struct mat2 *b) {
	mat2_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct mat2* psmat2_lerp(struct mat2 *result, struct mat2 *a,
		struct mat2 *b, mfloat_t p) {
...
MATHC_INLINE struct mat3* psmat3_assign_mat2(struct mat3 *result,
		struct mat2 *m) {
	mat3_assign_mat2((mfloat_t*) result, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct mat3* psmat3_assign_mat4(struct mat3 *result,
		struct mat4 *m) {
	mat3_assign_mat4((mfloat_t*) result, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct mat3* psmat3_transpose(struct mat3 *result,
		struct mat3 *m) {
...
MATHC_INLINE struct mat3* psmat3_rotation_x(struct mat3 *result,
		mfloat_t angle) {
	mat3_rotation_x((mfloat_t*) result, angle);
	return result;
}

MATHC_INLINE struct mat3* psmat3_rotation_y(struct mat3 *result,
		mfloat_t angle) {
	mat3_rotation_y((mfloat_t*) result, angle);
	return result;
}

MATHC_INLINE struct mat3* psmat3_rotation_z(struct mat3 *result,
		mfloat_t angle) {
	mat3_rotation_z((mfloat_t*) result, angle);
	return result;
}

MATHC_INLINE struct mat3* psmat3_rotation_axis(struct mat3 *result,
		struct vec3 *a, mfloat_t angle) {
	mat3_rotation_axis((mfloat_t*) result, (mfloat_t*) a, angle);
	return result;
}

MATHC_INLINE struct mat3* psmat3_rotation_quaternion(struct mat3 *result,
		struct quat *q) {
...
MATHC_INLINE struct mat3* psmat3_scale(struct mat3 *result, struct mat3 *m,
		mfloat_t s) {
	mat3_scale((mfloat_t*) result, (mfloat_t*) m, s);
	return result;
}

MATHC_INLINE struct mat3* psmat3_multiply(struct mat3 *result, struct mat3 *a,
		struct mat3 *b) {
	mat3_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct mat3* psmat3_lerp(struct mat3 *result, struct mat3 *a,
		struct mat3 *b, mfloat_t p) {
...
MATHC_INLINE struct mat4* psmat4_assign_mat2(struct mat4 *result,
		struct mat2 *m) {
	mat4_assign_mat2((mfloat_t*) result, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct mat4* psmat4_assign_mat3(struct mat4 *result,
		struct mat3 *m) {
	mat4_assign_mat3((mfloat_t*) result, (mfloat_t*) m);
	return result;
}

MATHC_INLINE struct mat4* psmat4_transpose(struct mat4 *result,
		struct mat4 *m) {
...
MATHC_INLINE struct mat4* psmat4_ortho(struct mat4 *result, mfloat_t l,
		mfloat_t r, mfloat_t b, mfloat_t t, mfloat_t n, mfloat_t f) {
	mat4_ortho((mfloat_t*) result, l, r, b, t, n, f);
	return result;
}

MATHC_INLINE struct mat4* psmat4_perspective(struct mat4 *result,
		mfloat_t fov_y, mfloat_t aspect, mfloat_t n, mfloat_t f) {
	mat4_perspective((mfloat_t*) result, fov_y, aspect, n, f);
	return result;
}

MATHC_INLINE struct mat4* psmat4_perspective_fov(struct mat4 *result,
		mfloat_t fov, mfloat_t w, mfloat_t h, mfloat_t n, mfloat_t f) {
	mat4_perspective_fov((mfloat_t*) result, fov, w, h, n, f);
	return result;
}

MATHC_INLINE struct mat4* psmat4_perspective_infinite(struct mat4 *result,
		mfloat_t fov_y, mfloat_t aspect, mfloat_t n) {
	mat4_perspective_infinite((mfloat_t*) result, fov_y, aspect, n);
	return result;
}

MATHC_INLINE struct mat4* psmat4_rotation_x(struct mat4 *result,
		mfloat_t angle) {
	mat4_rotation_x((mfloat_t*) result, angle);
	return result;
}

MATHC_INLINE struct mat4* psmat4_rotation_y(struct mat4 *result,
		mfloat_t angle) {
	mat4_rotation_y((mfloat_t*) result, angle);
	return result;
}

MATHC_INLINE struct mat4* psmat4_rotation_z(struct mat4 *result,
		mfloat_t angle) {
	mat4_rotation_z((mfloat_t*) result, angle);
	return result;
}

MATHC_INLINE struct mat4* psmat4_rotation_axis(struct mat4 *result,
		struct mat4 *a, mfloat_t angle) {
	mat4_rotation_axis((mfloat_t*) result, (mfloat_t*) a, angle);
	return result;
}

MATHC_INLINE struct mat4* psmat4_rotation_quaternion(struct mat4 *result,
		struct mat4 *q) {
	mat4_rotation_quaternion((mfloat_t*) result, (mfloat_t*) q);
	return result;
}

MATHC_INLINE struct mat4* psmat4_look_at(struct mat4 *result,
		struct vec3 *position, struct vec3 *target, struct vec3 *up_axis) {
	mat4_look_at((mfloat_t*) result, (mfloat_t*) position, (mfloat_t*) target,
			(mfloat_t*) up_axis);
	return result;
}

MATHC_INLINE struct mat4* psmat4_translation(struct mat4 *result,
		struct mat4 *v) {
...
MATHC_INLINE struct mat4* psmat4_scale(struct mat4 *result, struct mat4 *m,
		mfloat_t s) {
	mat4_scale((mfloat_t*) result, (mfloat_t*) m, s);
	return result;
}

MATHC_INLINE struct mat4* psmat4_multiply(struct mat4 *result, struct mat4 *a,
		struct mat4 *b) {
	mat4_multiply((mfloat_t*) result, (mfloat_t*) a, (mfloat_t*) b);
	return result;
}

MATHC_INLINE struct mat4* psmat4_lerp(struct mat4 *result, struct mat4 *a,
		struct mat4 *b, mfloat_t p) {
...
MATHC_INLINE bool svec2_is_nearly_equal(struct vec2 a, struct vec2 b,
		mfloat_t epsilon) {
	return vec2_is_nearly_equal((mfloat_t*) &a, (mfloat_t*) &b, epsilon);
}
...
MATHC_INLINE struct vec2 svec2_clamp(struct vec2 a, struct vec2 lower,
		struct vec2 higher) {
	struct vec2 result;
	vec2_clamp((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &lower,
			(mfloat_t*) &higher);
...
MATHC_INLINE struct vec2 svec2_bezier3(struct vec2 a, struct vec2 b,
		struct vec2 c, mfloat_t p) {
	struct vec2 result;
	vec2_bezier3((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &b,
			(mfloat_t*) &c, p);
	return result;
...
MATHC_INLINE struct vec2 svec2_bezier4(struct vec2 a, struct vec2 b,
		struct vec2 c, struct vec2 d, mfloat_t p) {
	struct vec2 result;
	vec2_bezier4((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &b,
			(mfloat_t*) &c, (mfloat_t*) &d, p);
	return result;
...
MATHC_INLINE struct vec2i svec2i_clamp(struct vec2i a, struct vec2i lower,
		struct vec2i higher) {
	struct vec2i result;
	vec2i_clamp((mint_t*) &result, (mint_t*) &a, (mint_t*) &lower,
			(mint_t*) &higher);
...
MATHC_INLINE struct vec2i svec2i_lerp(struct vec2i a, struct vec2i b,
		mfloat_t p) {
	struct vec2i result;
	vec2i_lerp((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, p);
	return result;
...
MATHC_INLINE struct vec2i svec2i_bezier3(struct vec2i a, struct vec2i b,
		struct vec2i c, mfloat_t p) {
	struct vec2i result;
	vec2i_bezier3((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, (mint_t*) &c,
			p);
	return result;
}

MATHC_INLINE struct vec2i svec2i_bezier4(struct vec2i a, struct vec2i b,
		struct vec2i c, struct vec2i d, mfloat_t p) {
	struct vec2i result;
	vec2i_bezier4((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, (mint_t*) &c,
			(mint_t*) &d, p);
	return result;
...
MATHC_INLINE bool svec3_is_nearly_equal(struct vec3 a, struct vec3 b,
		mfloat_t epsilon) {
	return vec3_is_nearly_equal((mfloat_t*) &a, (mfloat_t*) &b, epsilon);
}
...
MATHC_INLINE struct vec3 svec3_clamp(struct vec3 a, struct vec3 lower,
		struct vec3 higher) {
	struct vec3 result;
	vec3_clamp((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &lower,
			(mfloat_t*) &higher);
...
MATHC_INLINE struct vec3 svec3_bezier3(struct vec3 a, struct vec3 b,
		struct vec3 c, mfloat_t p) {
	struct vec3 result;
	vec3_bezier3((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &b,
			(mfloat_t*) &c, p);
	return result;
...
MATHC_INLINE struct vec3 svec3_bezier4(struct vec3 a, struct vec3 b,
		struct vec3 c, struct vec3 d, mfloat_t p) {
	struct vec3 result;
	vec3_bezier4((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &b,
			(mfloat_t*) &c, (mfloat_t*) &d, p);
	return result;
...
MATHC_INLINE struct vec3i svec3i_clamp(struct vec3i a, struct vec3i lower,
		struct vec3i higher) {
	struct vec3i result;
	vec3i_clamp((mint_t*) &result, (mint_t*) &a, (mint_t*) &lower,
			(mint_t*) &higher);
...
MATHC_INLINE struct vec3i svec3i_lerp(struct vec3i a, struct vec3i b,
		mfloat_t p) {
	struct vec3i result;
	vec3i_lerp((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, p);
	return result;
...
MATHC_INLINE struct vec3i svec3i_bezier3(struct vec3i a, struct vec3i b,
		struct vec3i c, mfloat_t p) {
	struct vec3i result;
	vec3i_bezier3((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, (mint_t*) &c,
			p);
	return result;
}

MATHC_INLINE struct vec3i svec3i_bezier4(struct vec3i a, struct vec3i b,
		struct vec3i c, struct vec3i d, mfloat_t p) {
	struct vec3i result;
	vec3i_bezier4((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, (mint_t*) &c,
			(mint_t*) &d, p);
	return result;
...
MATHC_INLINE bool svec4_is_nearly_equal(struct vec4 a, struct vec4 b,
		mfloat_t epsilon) {
	return vec4_is_nearly_equal((mfloat_t*) &a, (mfloat_t*) &b, epsilon);
}
...
MATHC_INLINE struct vec4 svec4_clamp(struct vec4 a, struct vec4 lower,
		struct vec4 higher) {
	struct vec4 result;
	vec4_clamp((mfloat_t*) &result, (mfloat_t*) &a, (mfloat_t*) &lower,
			(mfloat_t*) &higher);
...
MATHC_INLINE struct vec4i svec4i_clamp(struct vec4i a, struct vec4i lower,
		struct vec4i higher) {
	struct vec4i result;
	vec4i_clamp((mint_t*) &result, (mint_t*) &a, (mint_t*) &lower,
			(mint_t*) &higher);
...
MATHC_INLINE struct vec4i svec4i_lerp(struct vec4i a, struct vec4i b,
		mfloat_t p) {
	struct vec4i result;
	vec4i_lerp((mint_t*) &result, (mint_t*) &a, (mint_t*) &b, p);
	return result;
...
MATHC_INLINE bool squat_is_nearly_equal(struct quat a, struct quat b,
		mfloat_t epsilon) {
	return quat_is_nearly_equal((mfloat_t*) &a, (mfloat_t*) &b, epsilon);
}
...
MATHC_INLINE struct quat squat_from_yaw_pitch_roll(mfloat_t yaw, mfloat_t pitch,
		mfloat_t roll) {
	struct quat result;
	quat_from_yaw_pitch_roll((mfloat_t*) &result, yaw, pitch, roll);
	return result;
...
MATHC_INLINE struct mat4 smat4_ortho(mfloat_t l, mfloat_t r, mfloat_t b,
		mfloat_t t, mfloat_t n, mfloat_t f) {
	struct mat4 result;
	mat4_ortho((mfloat_t*) &result, l, r, b, t, n, f);
	return result;
...
MATHC_INLINE struct mat4 smat4_perspective(mfloat_t fov_y, mfloat_t aspect,
		mfloat_t n, mfloat_t f) {
	struct mat4 result;
	mat4_perspective((mfloat_t*) &result, fov_y, aspect, n, f);
	return result;
...
MATHC_INLINE struct mat4 smat4_perspective_fov(mfloat_t fov, mfloat_t w,
		mfloat_t h, mfloat_t n, mfloat_t f) {
	struct mat4 result;
	mat4_perspective_fov((mfloat_t*) &result, fov, w, h, n, f);
	return result;
...
MATHC_INLINE struct mat4 smat4_perspective_infinite(mfloat_t fov_y,
		mfloat_t aspect, mfloat_t n) {
	struct mat4 result;
	mat4_perspective_infinite((mfloat_t*) &result, fov_y, aspect, n);
	return result;
...
MATHC_INLINE struct mat4 smat4_look_at(struct vec3 position, struct vec3 target,
		struct vec3 up_axis) {
	struct mat4 result;
	mat4_look_at((mfloat_t*) &result, (mfloat_t*) &position,
			(mfloat_t*) &target, (mfloat_t*) &up_axis);
	return result;
}
