...
const char* IntWallType(const int i) {
	static const char *wallTypes[] = { "o", "w", "e", "n", "s", "nw", "ne",
			"sw", "se", "wt", "et", "nt", "st", "v", "h", "x" };
	return wallTypes[i];
}
const char* IntWallStyle(const int i) {
	static const char *wallStyles[] = { "steel", "brick", "carbon", "steelwood",
			"stone", "plasteel", "granite" };
...
const char* IntFloorStyle(const int i) {
	static const char *floorStyles[] = { "recessed", "tile", "dirt", "flat",
			"striped", "smallsquare", "stone", "wood", "biggrid", "grid" };
...
const char* IntRoomStyle(const int i) {
	static const char *roomStyles[] = { "recessed", "tile", "dirt", "flat",
			"striped", "smallsquare", "stone", "wood", "grid", "biggrid",
			"checker" };
